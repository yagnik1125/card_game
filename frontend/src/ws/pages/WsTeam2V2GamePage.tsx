...
import WsGameBoardTeam from "@/ws/components/teams2v2/WsGameBoardTeam";
import WsTrickWinnerTeamModal from "@/ws/components/teams2v2/WsTrickWinnerTeamModal";
import WsRoundWinnerTeamModal from "@/ws/components/teams2v2/WsRoundWinnerTeamModal";
import WsWinnerTeamModal from "@/ws/components/teams2v2/WsWinnerTeamModal";
import WsTrumpDeclarationModal from "@/ws/components/common/WsTrumpDeclarationModal";

export default function WsTeam2V2GamePage() {
    ...
    const winnerTeamId = useSelector(selectWinnerTeamId);
    ...
    return (
        <div className="relative">
            ...
            />
            <WsTrickWinnerTeamModal
                trickWinner={trickWinner}
                trickWinnerTeam={trickWinnerTeam}
            />
            <WsRoundWinnerTeamModal roundWinnerTeam={roundWinnerTeam} />
