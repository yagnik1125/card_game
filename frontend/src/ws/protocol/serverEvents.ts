/**
 * Server -> client event contracts.
 *
 * Mirrors `backend/src/websocket/protocol/serverEvents.ts` exactly.
 * Payload keys follow the backend envelope shape (`winnerPlayerId`,
 * `trickNumber`, ...) — they are NOT the engine-shaped REST event keys.
 */
